	...
	var CommentBox = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(CommenList, { data: this.state.data }),
	...
	var CommentForm = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement('input', { type: 'text', placeholder: '이름', ref: 'author' }),
	      _react2.default.createElement('input', { type: 'text', placeholder: '내용을 입력하세요', ref: 'text' }),
	      _react2.default.createElement('input', { type: 'submit', value: '올리기' })
	    );
	  }
	});
	
	var data = [{ author: "Inhyup Kim", text: "댓글" }, { author: "Inwook Kim", text: "댓글2" }];
	
	(0, _reactDom.render)(_react2.default.createElement(CommentBox, { url: 'comments.json', pollInterval: 2000 }), document.getElementById('container'));
